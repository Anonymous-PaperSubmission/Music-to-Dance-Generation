...
parser.add_argument('--joints_category', type=str, default='WU', help='choose joints category')
...
folder = '../Dataset/Tang2018/Raw/'
save_folder = './Dataset/Tang2018/'
